...
I put some well-kown networks in face recognition domain in the "models" folder, such as "resnet.py" (ResNet), "insightface.py" (ArcFace), "sphereface.py" (SphereFace), and "insightface_v2.py" (CurricularFace).
